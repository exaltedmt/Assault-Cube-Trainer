...
#define DLL_PATH_X64 TEXT("C:\\Users\\virul\\Documents\\Projects\\Memory_Editing\\GHTut4\\Debug\\GHTut4.dll")

#define PROCESS_NAME_X86 TEXT("GHTut4 - x86.exe")
#define PROCESS_NAME_X86 TEXT("GHTut4 - x64.exe")
...
bool InjectDll(const TCHAR* szProcess, const TCHAR* szPath, LAUNCH_METHOD Method)
{
	...
	{
		DWORD dwErr = GetLastError();
		printf("VirutalAllocEx failed: 0x%08X\n", dwErr);
